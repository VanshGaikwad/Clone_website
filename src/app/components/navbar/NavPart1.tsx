    ...
    <div>
      <div className='flex items-center gap-4'>
        <a href="https://skiper-ui.com/" className='flex gap-2 items-center '>
          ...
          <h4 className='font-bold text-black'>Vansh/ui</h4>
           <span className='text-[10px]  border-1 text-orange-600 border-orange-600 rounded-xl px-1.5'>Beta</span>
          </a>
          <a href="#" className='text-gray-600 font-medium text-sm'>Component</a>
          <a href="#" className='text-gray-600 font-medium text-sm'>Pricing</a>
          <a href="#" className='text-gray-600 font-medium text-sm'>Newsletter</a>
